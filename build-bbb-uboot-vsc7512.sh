...
# => setenv pcb 'pcb134'
# => setenv bootcmd 'dhcp <TFTP_IP>:<path>/armv7_vsc7512.itb; run ramboot'
# => saveenv
#
# The armv7_vsc7512 is build in the next section:
else
    echo "bbb.img alreadfy exist so skipping that part"
fi


# (2.1) --- Get MESA and prepare a mesa-demo build for VSC7512 running on Beaglebone.
#
...
cd mesa-v2024.03
.cmake/create_cmake_project.rb arm my-vsc7512_bbb
cd my-vsc7512_bbb
./cmake .. -DIMG_armv7_vsc7512_fit=ON
